...
function ProductApp(props) {
  ...
  // Function to handle category change with transition effect
  const handleCategoryChange = (category, func) => {
    // Trigger fade-out effect
    setFadeClass('');
    setTimeout(() => {
      // Change category and apply fade-in effect
      setActiveCategory(category);
      func(); // Call the function to update the cards
      setFadeClass('fade-in');
    }, 200); // Match the duration with CSS transition time
  };
    ...
    return (
        <div className="product-page-container">
            <TabGroup role={props.role} funct={handleCategoryChange} funct0={funct0} funct1={funct1} funct2={funct2} funct3={funct3} funct4={softDeleted}></TabGroup>
            <div className={`card-container ${fadeClass}`}>
